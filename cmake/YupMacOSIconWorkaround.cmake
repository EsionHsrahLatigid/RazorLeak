...
# "Invalid Iconset" on current macOS runners. Convert the same source PNG
# directly with sips and override only YUP's private conversion hook.
# Remove this workaround once the pinned YUP commit generates a complete
# iconset accepted by macOS 26 iconutil.

find_program(RAZORLEAK_SIPS_EXECUTABLE sips REQUIRED)
...
function(_yup_convert_png_to_icns png_path icons_path output_variable)
    ...
    execute_process(
        COMMAND "${RAZORLEAK_SIPS_EXECUTABLE}"
